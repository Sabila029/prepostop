...
<body>
  ...
  <div class="container mt-3">
            ...
            <div class="row mb-3">
              <div>
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="gender" id="gender_Laki-laki" value="0" readonly>
    ...
    <br>
    <div class="mb-3"><b>KEHAMILAN SEKARANG</b></div>
    <div class="mb-3">
      <div class="col-md-10">
        <label for="">G</label>
        :<input type="text" id="v_09" name="v_09" style="width: 50px;">
        P :<input type="text" id="v_10" name="v_10" style="width: 50px;">
        A :<input type="text" id="v_11" name="v_11" style="width: 50px;">
      </div>
    </div>
    ...
    <div class="mb-3">
      <div class="col-6">
        <div class="col-md-12">
          ...
          : <input type="date" id="v_20" name="v_20"> Jam
          : <input type="time" id="v_21" name="v_21">
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-6">
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              : Kala I : <input type="time" id="v_28" name="v_28"> Jam
            </div>
          </div>
        </div>
        <div class="col-6">
          <div class="col-md-12">
            ...
            : <input type="time" id="v_29" name="v_29"> menit
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="mb-3">
      <div class="row mb-3">
        ...
        <div class="col-md-6">
          : <input type="time" id="v_30" name="v_30"> jam sebelum persalinan
        </div>
      </div>
    </div>
    ...
    <div class="mb-3">
      <div class="row mb-3">
        ...
        <div class="col-md-6">
          : <input type="text" id="v_31" name="v_31" style="width: 500px;" required autofocus>
        </div>
      </div>
    </div>
    ...
    <div class="mb-5">
      <div class="row mb-3">
        ...
        <div class="col-md-6">
          : <input type="text" id="v_33" name="v_33" style="width: 500px;" required autofocus>
        </div>
      </div>
    </div>
