     ...
     <div class="container mt-3" >
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
               <div class="row mb-3">
                                <div class="col-md-4">
                                    <label for="v_01">No. Rekam Medik</label>
                                </div>
                                <div class="col-md-6">
                                    :<input type="text" id="no_Registration" name="no_Registration" style="width: 150px;" autofocus readonly>
                                </div>
                            </div>

                 <div class="row mb-3">
                                <div class="col-md-4">
                                    <label id="v_02_nama">Nama Lengkap</label>
                                </div>
                                <div class="col-md-6">
      ...
      <form>
          ...
          <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    :<input type="text" id="v_02" name="v_02" style="width: 150px;">
                                </div>
                            </div>
          <div class="row mb-3">
                                <div class="col-md-4">
          ...
          <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    : Rp<input type="text" id="v_07" name="v_07" style="width: 150px;" >
                                </div>
                            </div>
          <div class="row mb-5">
                                <div class="col-md-4">
          ...
          <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    : Rp<input type="text" id="v_14" name="v_14" style="width: 150px;" >
                                </div>
                            </div>
          <div class="row mb-5">
                                <div class="col-md-4">
          ...
          <div class="mb-3">
            ...
            <div class="mb-5">
                              <label for="alasan" type="text">Nilai-nilai kepercayaan/keyakinan tertentu terkait kondisi pasien</label>
                              <input type="text" id="v_28" name="v_28" style="width: 500px">
                            </div>
