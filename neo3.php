    ...
    <div class="container mt-3" >
      ...
      <table class="table table-bordered mb-0" style="border: 1px solid black;">
            ...
            <td>
               <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    :<input type="text" for="thename"  name="thename" style="width: 150px;" readonly>
                                </div>
                            </div>
                  <div class="row mb-3">
                                <div class="col-md-4">
       ...
       <br><div class="mb-3"><b>KEADAAN BAYI SAAT LAHIR</b></div>
                ...
                <div class="mb-3">
                                <div>
                                   <label class="col-2" for="">Kelahiran</label>
                                    <div class="form-check form-check-inline">
                ...
                <div class="mb-5">
          <div class="col-md-10">
               <label class="col-2" for="">Antropometri saat lahir  </label>
               BB :<input type="text" id="v_03" name="v_03" style="width: 50px;" >gram
               PB :<input type="text" id="v_04" name="v_04" style="width: 50px;" >cm
               LK :<input type="text" id="v_05" name="v_05" style="width: 50px;" >cm
               LD :<input type="text" id="v_06" name="v_06" style="width: 50px;" >cm
               LLA :<input type="text" id="v_07" name="v_07" style="width: 50px;" >cm
             </div>
           </div>
           ...
           <div class="mb-1"><b>PENILAIAN APGAR SCORE</b></div>
                   ...
                   <div class="mb-1">Lain-lain yang perlu dilaporkan:</div>
                   <div class="mb-3">
                   <div class="row mb-3">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-6">
                                   : <input type="text" id="v_13" name="v_13" style="width: 500px;" >
                                </div>
                            </div>
                          </div>
                   <div class="mb-5">
                   <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                   : <input type="text" id="v_14" name="v_14" style="width: 500px;" >
                                </div>
                            </div>
                          </div>
                   ...
                   <div class="row">
                    <div class="col-4">
                   <div class="mb-3">
                         TD :<input type="text" id="tension_upper" name="tension_upper" style="width: 40px;" readonly> /
                         <input type="text" id="tension_bellow" name="tension_bellow" style="width: 40px;" readonly >mmHg
                     </div>
                       <div class="mb-4">
                         Nadi :<input type="text" id="nadi" name="nadi" style="width: 50px;" readonly>x/menit
                       </div>
                     </div>
                     <div class="col-4">
                       <div class="mb-3">
                         P :<input type="text" id="panjang" name="panjang" style="width: 50px;" readonly>x/menit
                       </div>
                       <div class="mb-4">
                         Suhu :<input type="text" id="temperature" name="temperature" style="width: 50px;" readonly>°C
                       </div>
                     </div>
                     <div class="col-4">
                       <div class="mb-5">
                         SpO2 :<input type="text" id="saturasi" name="saturasi" style="width: 50px;" readonly >
                       </div>
                     </div>
                     </div>
                   ...
                   <div class="mb-5">
                        <div class="col-md-10">
                             ...
                             BB :<input type="text" id="weight" name="weight" style="width: 50px;" readonly>gram
                             PB :<input type="text" id="height" name="height" style="width: 50px;" readonly=>cm
                             LK :<input type="text" id="head_circumference" name="head_circumference" style="width: 50px;" readonly>cm
                             LD :<input type="text" id="chest_size" name="chest_size" style="width: 50px;" readonly>cm
                             LLA :<input type="text" id="LLA" name="LLA" style="width: 50px;" readonly>cm
                           </div>
                         </div>
                  ...
                  <div class="col-6">
                  <div class="col-md-12">
                     <label for="">Peristaltik usus</label>
                   : <input type="text" id="v_23" name="v_23" >x/menit 
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                   ...
                   : <input type="text" id="v_24" name="v_24" >cm 
                    </div>
                  </div>
              </div>
            </div>
                  ...
                  <div class="col-md-12">
                   ...
                   : <input type="text" id="v_25" name="v_25" >x/hari 
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                  <div class="col-md-12">
                     <label for="">Diuresis</label>
                   : <input type="text" id="v_28" name="v_28" >ml/jam
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                   ...
                   : <input type="text" id="v_29" name="v_29" >
                    </div>
                  </div>
              </div>
            </div>
