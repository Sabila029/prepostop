          ...
          <tr>
            ...
            <td>
               <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    :<input type="text" id="no_Registration " name="no_Registration " style="width: 150px;" required autofocus readonly>
                                </div>
                            </div>
                                ...
                                <div>
                                   <label for="">Jenis Kelamin</label>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="gender_Laki-laki" value="0">
                                        <label class="form-check-label" for="gender_Laki-laki">Laki-laki</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="gender_Perempuan" value="1">
                     ...
                     <table class="table table-bordered md-0" style="border: 1px solid black;">
                       <tbody>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_02" name="v_02" style="width: 110px"></td>
                           <td>Anemia</td>
                           <td><input type="date" id="v_03" name="v_03" style="width: 110px"></td>
                           <td style="text-align: center;">15</td>
                           <td><input type="date" id="v_04" name="v_04" style="width: 110px"></td>
                           <td>Menyusui tidak efektif</td>
                           <td><input type="date" id="v_05" name="v_05" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_06" name="v_06" style="width: 110px"></td>
                           <td>Bersihan jalan napas tidak efektif</td>
                           <td><input type="date" id="v_07" name="v_161" style="width: 110px"></td>
                           <td style="text-align: center;">16</td>
                           <td><input type="date" id="v_08" name="v_08" style="width: 110px"></td>
                           <td>Gangguan eliminasi urin</td>
                           <td><input type="date" id="v_09" name="v_09" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_10" name="v_10" style="width: 110px"></td>
                           <td>DefisitNutrisi</td>
                           <td><input type="date" id="v_11" name="v_11" style="width: 110px"></td>
                          <td style="text-align: center;">17</td>
                           <td><input type="date" id="v_12" name="v_12" style="width: 110px"></td>
                           <td>Risiko ketidakseimbangan cairan</td>
                           <td><input type="date" id="v_13" name="v_13" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_14" name="v_14" style="width: 110px"></td>
                           <td>Diare</td>
                           <td><input type="date"  id="v_15" name="v_15" style="width: 110px"></td>
                           <td style="text-align: center;">18</td>
                           <td><input type="date"  id="v_16" name="v_16" style="width: 110px"></td>
                           <td>Risiko ketidakseimbangan elektrolit</td>
                           <td><input type="date"  id="v_17" name="v_17" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr> 
                           ...
                           <td><input type="date" id="v_18" name="v_18" style="width: 110px"></td>
                           <td>Gangguan eliminasi urin</td>
                           <td><input type="date" id="v_19" name="v_19" style="width: 110px"></td>
                           <td style="text-align: center;">19</td>
                           <td><input type="date" id="v_20" name="v_20" style="width: 110px"></td>
                           <td>Risiko ikterus neonatus</td>
                           <td><input type="date" id="v_21" name="v_21" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_22" name="v_22" style="width: 110px"></td>
                           <td>Gangguan integritas kulit/jaringan</td>
                           <td><input type="date" id="v_23" name="v_23" style="width: 110px"></td>
                           <td style="text-align: center;">20</td>
                           <td><input type="date" id="v_24" name="v_24" style="width: 110px"></td>
                           <td>Risiko infeksi</td>
                           <td><input type="date" id="v_25" name="v_25" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_26" name="v_26" style="width: 110px"></td>
                           <td>Gangguan pertukaran gas</td>
                           <td><input type="date" id="v_27" name="v_27" style="width: 110px"></td>
                           <td style="text-align: center;">21</td>
                           <td><input type="date" id="v_28" name="v_28" style="width: 110px"></td>
                           <td>Risiko jatuh</td>
                           <td><input type="date" id="v_29" name="v_29" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_30" name="v_30" style="width: 110px"></td>
                           <td>Hipervolemia</td>
                           <td><input type="date" id="v_31" name="v_31" style="width: 110px"></td>
                          <td style="text-align: center;">22</td>
                           <td><input type="date" id="v_32" name="v_32" style="width: 110px"></td>
                           <td>Risiko termoregulasi tidak efektif</td>
                           <td><input type="date" id="v_33" name="v_33" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_34" name="v_34" style="width: 110px"></td>
                           <td>Hipovolemia</td>
                           <td><input type="date" id="v_35" name="v_35" style="width: 110px"></td>
                           <td style="text-align: center;">23</td>
                           <td><input type="date" id="v_36" name="v_36" style="width: 110px"></td>
                           <td>Risiko gangguan integritas kulit</td>
                           <td><input type="date" id="v_37" name="v_37" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_38" name="v_38"  style="width: 110px"></td>
                           <td>Ikterik neonatus</td>
                           <td><input type="date" id="v_39" name="v_39" style="width: 110px"></td>
                          <td style="text-align: center;">24</td>
                           <td><input type="date" id="v_40" name="v_40" style="width: 110px"></td>
                           <td>Risiko perfusi perifer tidak efektif</td>
                           <td><input type="date" id="v_41" name="v_41" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_42" name="v_42" style="width: 110px"></td>
                           <td>Hipotermia</td>
                           <td><input type="date" id="v_43" name="v_43" style="width: 110px"></td>
                          <td style="text-align: center;">25</td>
                           <td><input type="date" id="v_44" name="v_44" style="width: 110px"></td>
                           <td>Risiko konstipasi</td>
                           <td><input type="date" id="v_45" name="v_45" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_46" name="v_46" style="width: 110px"></td>
                           <td>Hipertermia</td>
                           <td><input type="date" id="v_47" name="v_47" style="width: 110px"></td>
                           <td style="text-align: center;">26</td>
                           <td><input type="date" id="v_48" name="v_48" style="width: 110px"></td>
                           <td>Kurang pengetahuan orangtua</td>
                           <td><input type="date" id="v_49" name="v_49" style="width: 110px"></td></td>
                         </tr>


                         <tr>
                           <td style="text-align: center;">13</td>
                           <td><input type="date" id="v_50" name="v_50" style="width: 110px"></td>
                           <td>Nyeri akut</td>
                           <td><input type="date" id="v_51" name="v_51" style="width: 110px"></td>
                          <td style="text-align: center;">27</td>
                           <td><input type="date" id="v_52" name="v_52" style="width: 110px"></td>
                           <td>
                             <label>Lain-lain</label>
                             <input type="text" id="v_53" name="v_53" style="width: 100px">
                           </td>
                           <td><input type="date" id="v_54" name="v_54" style="width: 110px"></td></td>
                         </tr>
                         ...
                         <tr>
                           ...
                           <td><input type="date" id="v_55" name="v_55" style="width: 110px"></td>
                           <td>Pola napas tidak efektif</td>
                           <td><input type="date" id="v_56" name="v_56" style="width: 110px"></td>
                           <td style="text-align: center;">28</td>
                           <td><input type="date" id="v_57" name="v_57" style="width: 110px"></td>
                           <td>
                             <label>Lain-lain</label>
                             <input type="text" id="v_58" name="v_58" style="width: 100px">
                           </td>
                           <td><input type="date" id="v_59" name="v_59" style="width: 110px"></td></td>
                         </tr>
